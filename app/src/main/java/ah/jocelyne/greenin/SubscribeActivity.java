...
public class SubscribeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(!error_found) {
                    final SubscribedUser subscribedUser = new SubscribedUser(fname, lname, email2);
                    ...
                    usersRef.addValueEventListener(new ValueEventListener() {
                        ...
                        public void onDataChange(DataSnapshot dataSnapshot) {
                            ...
                            for(DataSnapshot user : dataSnapshot.getChildren()) {
                                if (email2.equalsIgnoreCase(user.child("email").getValue(String.class))) {
                                    user_exists = true;
                                }
                            }
                            ...
                            if(user_exists == false && round < 2) {
                                ...
                                usersRef.push().setValue(subscribedUser);

                                //send confirmation email
                                sendEmail();

                                Toast.makeText(getApplicationContext(), "You have been subscribed!", Toast.LENGTH_LONG).show();
                                fn.setText("");
                                ln.setText("");
                                email.setText("");
                            }
                                ...
                                Toast.makeText(getApplicationContext(), "This email address is already subscribed.", Toast.LENGTH_LONG).show();
                            }
                        }
                        @Override
    ...
    private void sendEmail() {
        ...
        String subject = "GreenIn Subscription Confirmation";
        String message = "Dear " + fname + ",\n\nThank you for subscribing to news and updates from GreenIn."
                + " Let's make Lebanon green again!\n\nThe GreenIn Team";
